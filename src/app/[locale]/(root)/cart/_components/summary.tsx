    ...
    <div className="flex flex-col gap-5">
      <div className="my-5 flex flex-col gap-7">
        <div className="flex items-center justify-between">
          ...
          <span className="font-bold text-secondary-foreground">$315</span>
        </div>
        <div className="flex items-center justify-between">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="font-bold text-secondary-foreground">$0.0</span>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between rounded-sm bg-lightPrimary p-5">
        ...
        <span className="font-bold text-secondary-foreground">$300</span>
      </div>
      <div className="flex items-center justify-between">
